...
#ifndef BOOMPIKIT_SWIFT_H
#define BOOMPIKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BoompiKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9BoompiKit12BoompiClient")
@interface BoompiClient : NSObject
...
@interface BoompiClient (SWIFT_EXTENSION(BoompiKit)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface BoompiClient (SWIFT_EXTENSION(BoompiKit)) <CBCentralManagerDelegate>
