...
export interface Settings {
  ...
  /** AirPlay pairing code (null = no code required). Generated by the
      daemon when enabled; also shown on the panel. */
  airplay_pin: string | null;
  name: string;
  theme: Theme;
...
export interface SettingsPatch {
  ui_scale?: number;
  airplay_model?: string;
  /** Enable/disable the AirPlay pairing code (code is generated). */
  airplay_pin_enabled?: boolean;
  name?: string;
  theme?: Theme;
  online_art_fallback?: boolean;
  update_channel?: UpdateChannel;
